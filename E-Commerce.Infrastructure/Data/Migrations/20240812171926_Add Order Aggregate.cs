        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShippingAddress_StreetName = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductItem_ProductItemId = table.Column<int>(type: "int", nullable: false),
                    ProductItem_ProductName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductItem_ProductImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
